...
class NinjutsuPlugin(Star):
    def __init__(self, context):
        ...
        self.ninjutsu_mapping = {
            ...
            "河水罗汉离子手": "shiyongluohanshouheshuiluohanlizishou.wav",
            "使用罗汉手": "shiyongluohanshouheshuiluohanlizishou.wav",
            "俺会是你的罗翔啊": "anhuishinideluoxianga.wav",
            "俺要立希的专辑": "anyaolixidezhuanji.wav",
            "十万条霹雳狗": "shiwantiaopiligou.wav",
            "十亿响刀落一万刀一百万刀": "shiyixiangdaoluoyiwandaoyibaiwandao.wav",
            ...
            "回来吧我心爱的手": "huilaibawoxinaideshouyingfenshenhuanrao.wav",
            "影分身环绕": "huilaibawoxinaideshouyingfenshenhuanrao.wav",
            ...
            "射不尽": "shebujin.wav",
            "小男孩为难为难": "xiaonanhaiweinanweinanhalashao.wav",
            "哈拉少": "xiaonanhaiweinanweinanhalashao.wav",
            ...
            "影分身十字手": "yingfenshenshizishou.wav",
            "影分身十字刀": "yingfenshenshizizhannamiyouyouqiu.wav",
            "纳米悠悠球": "yingfenshenshizizhannamiyouyouqiu.wav",
            "影分身十字斩": "yingfenshenshizizhannamiyouyouqiu.wav",
            "影暗流幻影诺手": "yinganliuhuanyingnuoshou.wav",
            ...
            "我不是人类": "wobushirenleiwohemeixisaipao.wav",
            "我和梅西赛跑": "wobushirenleiwohemeixisaipao.wav",
            ...
            "我最后悔的事": "wozijidahaorenshengbuguowozuihouhuideshi.wav",
            "我自己大好人生不过": "wozijidahaorenshengbuguowozuihouhuideshi.wav",
            ...
            "暗威雷龙迅": "anweileilongxun.wav",
            "暗寒死术": "anhansishu.wav",
            "暗幕引雷电": "anmuyinleidian.wav",
            "暗影魔刀": "anyingmodao.wav",
            "暗影魔刀使": "anyingmodaoshi.wav",
            "暗流shinnobi速杀内燃手": "anliusushaneiranshou_shinnobi.wav",
            "暗神雷霆": "anshenleiting.wav",
            "暗部煞并雷鸣": "anbushabingleiming.wav",
            "暗黑尔德machine": "anheierde_machine.wav",
            "暗黑堕落挥刀斩": "anheishiheizizhananheiduoluohuidaozhan.wav",
            "暗黑式黑子斩": "anheishiheizizhananheiduoluohuidaozhan.wav",
            ...
            "死神环绕": "sishenhuanraosixianghuanrao.wav",
            "四象环绕": "sishenhuanraosixianghuanrao.wav",
            ...
            "热爱海虎我的海虎": "reaihaihuwodehaihureai_galgame.wav",
            "热爱galgame": "reaihaihuwodehaihureai_galgame.wav",
            ...
            "王亨御剑龙": "wanghengyujianlonghanyuyanlong_or.wav",
            "汉域炎龙": "wanghengyujianlonghanyuyanlong_or.wav",
    ...
    async def cmd_ninjutsu(self, event: AstrMessageEvent):
        cmd_name = "释放忍术"  # 建立cmd_name识别输入,并开始事件
        input_text = event.message_str.strip()  # 采集命令后指令
        ...
        try:
            ...
            yield event.plain_result(f"吓我一跳我释放「{ninjutsu_name}」!")
            yield event.chain_result([Record(file=audio_file)])
